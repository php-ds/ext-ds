#ifndef PHP_DS_ARGINFO_H
#define PHP_DS_ARGINFO_H
...
#define ARGINFO_ZVAL_RETURN_BOOL(name, z) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 1, _IS_BOOL, 0) \
    ZEND_ARG_INFO(0, z) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_ZVAL_RETURN_BOOL(name, z) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 1, _IS_BOOL, NULL, 0) \
    ZEND_ARG_INFO(0, z) \
    ZEND_END_ARG_INFO()
#endif

#if PHP_VERSION_ID >= 70200
#define ARGINFO_CALLABLE_RETURN_BOOL(name, c) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 1, _IS_BOOL, 0) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 0) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_CALLABLE_RETURN_BOOL(name, c) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 1, _IS_BOOL, 0, 1) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 0) \
    ZEND_END_ARG_INFO()
#endif
...
#define ARGINFO_CALLABLE_RETURN_DS(name, c, col) \
    ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_##name, 0, 1, PHP_DS_NS(col), 1) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 0) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_CALLABLE_RETURN_DS(name, c, col) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 1, IS_OBJECT, PHP_DS_NS(col), 1) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 0) \
    ZEND_END_ARG_INFO()
#endif
...
#define ARGINFO_OPTIONAL_ZVAL_RETURN_DS(name, z, col) \
    ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_##name, 0, 0, PHP_DS_NS(col), 1) \
    ZEND_ARG_TYPE_INFO(0, z, 0, 1) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_OPTIONAL_ZVAL_RETURN_DS(name, z, col) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_OBJECT, PHP_DS_NS(col), 1) \
    ZEND_ARG_TYPE_INFO(0, z, 0, 1) \
    ZEND_END_ARG_INFO()
#endif
...
#define ARGINFO_OPTIONAL_STRING_RETURN_STRING(name, s) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_STRING, 0) \
    ZEND_ARG_TYPE_INFO(0, s, IS_STRING, 0) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_OPTIONAL_STRING_RETURN_STRING(name, s) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_STRING, NULL, 0) \
    ZEND_ARG_TYPE_INFO(0, s, IS_STRING, 0) \
    ZEND_END_ARG_INFO()
#endif
...
#if PHP_VERSION_ID >= 70200
#define ARGINFO_OPTIONAL_CALLABLE_RETURN_LONG(name, c) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_LONG, 0) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 1) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_OPTIONAL_CALLABLE_RETURN_LONG(name, c) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_LONG, 0, 1) \
    ZEND_ARG_TYPE_INFO(0, c, IS_CALLABLE, 1) \
    ZEND_END_ARG_INFO()
#endif
...
#else
#define ARGINFO_NONE_RETURN_LONG(name) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_LONG, NULL, 0) \
    ZEND_END_ARG_INFO()
#endif
...
#define ARGINFO_NONE_RETURN_DS(name, class_name) \
    ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_##name, 0, 0, PHP_DS_NS(class_name), 1) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_NONE_RETURN_DS(name, class_name) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_OBJECT, PHP_DS_NS(class_name), 1) \
    ZEND_END_ARG_INFO()
#endif

#if PHP_VERSION_ID >= 70200
#define ARGINFO_NONE_RETURN_OBJ(name, class_name) \
    ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_##name, 0, 0, class_name, 1) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_NONE_RETURN_OBJ(name, class_name) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_OBJECT, class_name, 1) \
    ZEND_END_ARG_INFO()
#endif
...
#define ARGINFO_NONE_RETURN_ARRAY(name) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_ARRAY, 0) \
    ZEND_END_ARG_INFO()
#else
#define ARGINFO_NONE_RETURN_ARRAY(name) \
    ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_##name, 0, 0, IS_ARRAY, NULL, 0) \
    ZEND_END_ARG_INFO()
#endif
