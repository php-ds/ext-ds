...
static zval *php_ds_deque_read_dimension(zval *obj, zval *offset, int type, zval *rv)
{
...
void php_ds_register_deque_handlers()
{
    ...
    php_ds_deque_handlers.free_obj         = php_ds_deque_free_object;
    php_ds_deque_handlers.get_gc           = php_ds_deque_get_gc;
    php_ds_deque_handlers.cast_object      = php_ds_common_cast_object;
    php_ds_deque_handlers.clone_obj        = php_ds_deque_clone_obj;
    php_ds_deque_handlers.get_debug_info   = php_ds_deque_get_debug_info;
    php_ds_deque_handlers.count_elements   = php_ds_deque_count_elements;

    php_ds_deque_handlers.read_dimension   = php_ds_deque_read_dimension;
    php_ds_deque_handlers.write_dimension  = php_ds_deque_write_dimension;
    php_ds_deque_handlers.has_dimension    = php_ds_deque_has_dimension;
    php_ds_deque_handlers.unset_dimension  = php_ds_deque_unset_dimension;
}
