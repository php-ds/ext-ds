...
void map_create_value_sequence(Map *map, zval *obj)
{
    htable_create_value_sequence(map->table, obj);
}

void map_create_pair_sequence(Map *map, zval *obj)
{
    htable_create_pair_sequence(map->table, obj);
}
