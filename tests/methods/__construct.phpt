...
E Argument 2 passed to Decimal\Decimal::__construct() must be of the type integer, string given
F Argument 2 passed to Decimal\Decimal::__construct() must be of the type integer, null given
